...
class FaceRecognizer:
    ...
    def __init__(self, model_path=None, smoothing_window=None):
        ...
        if smoothing_window is None:
            self.smoothing_window = ConfigManager.load().get("detection", {}).get("smoothing_window", 3)
        else:
